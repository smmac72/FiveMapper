...
{
    // input layout matches vertex { float3 pos; float3 nrm; float4 tan; float2 uv; }
    ...
    // rasterizer: use back-face culling to match default front winding
    d.RasterizerState.FillMode = D3D12_FILL_MODE_SOLID;
    d.RasterizerState.CullMode = D3D12_CULL_MODE_BACK;
    d.RasterizerState.FrontCounterClockwise = FALSE; // keep consistent with geometry
    d.RasterizerState.DepthClipEnable = TRUE;
    d.RasterizerState.DepthBias = 100;
